<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_Metting.aspx.cs" Inherits="Code_Work_Message_Add_Metting" %>
...
<body>
    ...
    <div style="width:100%">
    <table style="margin:auto;margin-top:20px;width:600px" class="table table-bordered">
           <tr>
               <td class="td">会议主题：</td>
       ...
       <div style="margin:auto;width:80px">
            <asp:Button ID="Add_Metting" runat="server" Text="发布会议"  CssClass="btn btn-danger" OnClick="add_click" />
       </div>
    </div>
        <script >
            !function () {
